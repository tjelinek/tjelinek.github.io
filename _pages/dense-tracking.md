...
MFT [1] tracks a point by chaining optical flow over logarithmically spaced baselines. Those long baselines are exactly the large-displacement, large-appearance-change regime that wide-baseline dense matchers are trained for, and RAFT [2] (MFT's flow backbone) is not. Swapping in a dense matcher on the confident matches, and keeping RAFT elsewhere, lifts long-term tracking accuracy.
...
For a matcher to slot into this scheme it has to supply a variance and an occlusion score. RoMa [3] provides neither, only a per-match certainty $$\rho \in [0,1]$$, so both are derived from it:
...
[1] M. Neoral, J. Šerých, J. Matas. *MFT: Long-Term Tracking of Every Pixel.* WACV, 2024.<br>
[2] Z. Teed, J. Deng. *RAFT: Recurrent All-Pairs Field Transforms for Optical Flow.* ECCV, 2020.<br>
[3] J. Edstedt, Q. Sun, G. Bökman, M. Wadenbäck, M. Felsberg. *RoMa: Robust Dense Feature Matching.* CVPR, 2024.<br>
[4] C. Doersch, A. Gupta, L. Markeeva, et al. *TAP-Vid: A Benchmark for Tracking Any Point in a Video.* NeurIPS Datasets and Benchmarks, 2022.<br>
[5] C. Doersch, Y. Yang, M. Vecerik, et al. *TAPIR: Tracking Any Point with Per-Frame Initialization and Temporal Refinement.* ICCV, 2023.<br>
[6] N. Karaev, I. Rocco, B. Graham, N. Neverova, A. Vedaldi, C. Rupprecht. *CoTracker: It Is Better to Track Together.* ECCV, 2024.<br>
[7] J. Edstedt, I. Athanasiadis, M. Wadenbäck, M. Felsberg. *DKM: Dense Kernelized Feature Matching for Geometry Estimation.* CVPR, 2023.
